        ...
        <>
            <div className="container d-flex justify-content-center">
                <div className="col-9 col-md-6 col-lg-6 d-flex">
                    <p style={{width: "120px", color: textColor}}><strong>{statName}</strong></p>
                    <div 
                    ...
                    >
                        {statValue ?
                            <div className="h-100 d-flex justify-content-start align-items-center" style={{background: `${background}`, borderRadius: "5px", width: `${max ? statValue / max * 100 : statValue/2}%`}}>
                                <span style={{paddingLeft: "2px", color: "white"}}><strong>{`${statValue}`}</strong></span>
                            </div>
                        :
                            <span style={{paddingLeft: "2px", color: "white"}}><strong>{`N/A`}</strong></span>
                        }
                    </div>
                </div>
            </div>
